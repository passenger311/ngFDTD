--[[---------------------------------------------------------------------------
module      : scape.collection.BinarySearchTree
version     : 0.9 
date        : 8/5/2008
author      : j.hamm
license     : x11 
...
--
-- <p><b>Implements:</b> 
-- <a href=scape.collection.BinaryTree.html>BinaryTree</a>,
-- <a href=scape.collection.ISearchTree.html>ISearchTree</a>
-- </p>
module("scape.collection.BinarySearchTree")
...
class.def( _M, 
	   require "scape.collection.BinaryTree",
	   require "scape.collection.ISearchTree"
	)
