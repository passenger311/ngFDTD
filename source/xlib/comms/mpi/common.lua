...
function inject(m)
   ...
   -- note: handlers, datatypes etc are dependend on MPI implementation and
   -- are therefore outsourced into separate files which are loaded prior to
   -- this one.
